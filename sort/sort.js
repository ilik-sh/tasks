...
let nums1 = Array.from({length: 100000}, () => Math.floor(Math.random() * 40))
let nums2 = Array.from({length: 100000}, () => Math.floor(Math.random() * 40))

let sortTimer = timer(quickSort)
sortTimer(nums1, 0, nums1.length-1)

sortTimer = timer(bubbleSort)
sortTimer(nums2)
